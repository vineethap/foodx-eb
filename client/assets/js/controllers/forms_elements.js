...
angular.module('foodXApp', ['ngSanitize', 'ui.select', 'summernote', 'ngDropzone'])
    // Chart controller 
    .controller('FormElemCtrl', ['$scope', '$sce', function($scope, $sce) {
    ...
    .directive('wysihtml5', function() {
        return {
            ...
            link: function(scope, element, attrs) {
                    ...
                    //TODO: chrome doesn't foodXApply the plugin on load
                setTimeout(function() {
                    $(element).wysihtml5({
                        html: true,
